setwd("/Users/gabrielbenedict/Google_Drive/docs/UNIS/KU Leuven/Courses/Master Thesis/Reconstructions/reproducing survival meta analysis/Modelling/WeibullNomu/")
...
setwd("../")
stanWeibFit <- stan(file = "weibNomu.stan", data = stanData)
...
draws <- as.array(stanWeibFit, pars = c('tau_s_bg_raw', 'tau_bg_raw', 'alpha_raw', ' beta_bg_raw', 'mu'))
